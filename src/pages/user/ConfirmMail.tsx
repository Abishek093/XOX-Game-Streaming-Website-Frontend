...
//     try {
//       await dispatch(confirmMail({ email: values.email })).unwrap();
//       navigate('/otp', { state: { email: values.email, isPasswordReset: true, isSignup: false } });
//     } catch (error: any) {
//       console.error('Email confirmation failed:', error);
//       alert(error.message || 'Email confirmation failed. Please try again.');
//     } finally {
//       setSubmitting(false);
//     }
//   };
